...
<body>
    ...
    <div class="header">
        ...
        <p>Hoşgeldiniz, Öğretim Üyemiz!</p>
    </div>
    ...
    <div class="menu-item">
        ...
        <a href="ogretim_uyesi_ortalama.php">Öğrenci Bilgileri</a>
 
        </div>
        <div class="menu-item">
            <i class="fa fa-book"></i>
            <a href="ogretimuyesinotekran.php?kullaniciId=<?php echo $KullaniciID; ?>">Not Girme</a>
        </div>
